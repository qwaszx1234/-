package com.kangfu.common.security.interceptor;
...
import com.kangfu.common.core.context.SecurityContextHolder;
...
public class HeaderInterceptor implements AsyncHandlerInterceptor
{
            ...
            throws Exception
    {
        ...
        SecurityContextHolder.setOrigin(ServletUtils.getHeader(request, SecurityConstants.ORIGIN));
